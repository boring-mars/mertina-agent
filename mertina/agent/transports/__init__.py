# Ported from hermes-agent agent/transports/__init__.py @ fbc4ea8b96
...
from mertina.agent.transports.types import (  # noqa: F401
    NormalizedResponse,
    ToolCall,
    Usage,
    build_tool_call,
...
def get_transport(api_mode: str) -> "ProviderTransport | None":
    """Return a transport instance for ``api_mode``, or None so callers can fall back to the
    legacy path."""
    # A directly-imported transport leaves the registry partial; (re)discover on first use and on
    # misses.
