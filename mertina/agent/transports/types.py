# Ported from hermes-agent agent/transports/types.py @ fbc4ea8b96
...
def build_tool_call(
    id: str | None,  # noqa: A002  # keeps the upstream signature
    name: str,
    arguments: Any,
    **provider_fields: Any,
) -> ToolCall:
    """Build a ``ToolCall``; dict *arguments* are JSON-serialised, extra kwargs become
    ``provider_data``."""
