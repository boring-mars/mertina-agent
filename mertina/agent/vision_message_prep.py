...
class VisionMessagePrepMixin:
    ...
    def _describe_image_for_anthropic_fallback(self, image_url: str, role: str) -> str:
        ...
        try:
            from mertina.tools.vision_tools import vision_analyze_tool
    ...
    def _model_supports_vision(self) -> bool:
        ...
        try:
            from mertina.agent.image_routing import _lookup_supports_vision
    ...
    def _provider_supports_vision_tool_messages(self) -> bool:
        ...
        try:
            from mertina.providers import routed_model_rejects_vision_tool_messages
    ...
    def _preprocess_anthropic_content(self, content: Any, role: str) -> Any:
        ...
        return (
            prefix
            or suffix
            or "[A multimodal message was converted to text for Anthropic compatibility.]"
        )
    ...
    _try_shrink_image_parts_in_messages = _forward_static(
        "mertina.agent.conversation_compression", "try_shrink_image_parts_in_messages"
    )
