...
from mertina.agent.message_sanitization import sanitize_outbound_kwargs
...
def _fire_pre_api_request_hook(
    ...
    *,
    ...
    from mertina.agent.conversation_loop import _system_prompt_for_hooks

    try:
        from mertina.cli.lifecycle import has_hook
...
def build_api_request(
    ...
    *,
    ...
    api_messages, _moa_prepared_request, tools_for_api = _redecorate_prompt_cache_for_provider(
        agent,
        api_messages,
    ...
    try:
        from mertina.cli.middleware import apply_llm_request_middleware
