...
from mertina.agent.provider_projection import splice_provider_projection
from mertina.agent.trajectory import has_incomplete_scratchpad
...
def _fire_post_api_request_hook(
    ...
    *,
    ...
    from mertina.agent.conversation_loop import _moa_reference_metrics_for_hook
    ...
    *,
    ...
    if agent.api_mode == "codex_responses" and finish_reason == "incomplete":
        ...
        if _codex_result is CODEX_FALLBACK_ACTIVATED:
            ...
            from mertina.agent.conversation_loop import _sync_failover_system_message
