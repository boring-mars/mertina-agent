# Ported from hermes-agent agent/turn_preflight_gate.py @ fbc4ea8b96
...
from mertina.agent.turn_context import _compression_warrants_another_preflight_pass
from mertina.agent.turn_preflight import PreflightGateVerdict, run_preflight_compression
...
def run_preflight_gate(
    ...
    *,
    ...
    from mertina.agent.conversation_loop import _ollama_context_limit_error
    ...
    return run_preflight_compression(
        ...
        defer_preflight=(
            (lambda _t: False)
            if getattr(agent, "_request_pressure_anchored", False)
