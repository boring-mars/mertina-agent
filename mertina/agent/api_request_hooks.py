# Ported from hermes-agent agent/api_request_hooks.py @ fbc4ea8b96
...
class ApiRequestHooksMixin:
        ...
        *,
        ...
        if isinstance(value, dict):
            ...
            for idx, (key, item) in enumerate(value.items()):
                ...
                str_key = str(key)
                out[str_key] = (
                    "<redacted>" if cls._is_sensitive_hook_key(str_key) else recurse(item)
                )
            return out
    ...
    def _invoke_api_request_error_hook(
        ...
        *,
        ...
        with suppress(Exception):
            from mertina.cli import lifecycle as _lifecycle
