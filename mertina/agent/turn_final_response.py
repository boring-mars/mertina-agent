...
from mertina.agent.turn_empty_response import recover_empty_response
from mertina.agent.turn_stop_gates import apply_stop_gates
...
def finish_text_response(
    ...
    *,
    ...
    from mertina.agent.agent_runtime_helpers import (
